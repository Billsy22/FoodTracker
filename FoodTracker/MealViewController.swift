...
class MealViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    // This value is either passed by the "MealTableViewController" in 'prepare(for:sender:)' or constructed as part of adding a new meal
    var meal: Meal?
    ...
    @IBAction func selectImageFromPhotoLibrary(_ sender: UITapGestureRecognizer) {
        ...
        // Make sure ViewController is notified when the user selects a photo
